...
BEGIN
    ...
    WITH articoli AS (
        SELECT 
            'AUDIO' as settore, cod, descrizione, categoria, quantita::INTEGER, ubicazione, attivo
        FROM articoli_audio
        UNION ALL
        SELECT 
            'LUCI' as settore, cod, descrizione, categoria, quantita::INTEGER, ubicazione, attivo
        FROM articoli_luci
        UNION ALL
        SELECT 
            'VIDEO' as settore, cod, descrizione, categoria, quantita::INTEGER, ubicazione, attivo
        FROM articoli_video
        UNION ALL
        SELECT 
            'ELETTRICO' as settore, cod, descrizione, categoria, quantita::INTEGER, ubicazione, attivo
        FROM articoli_elettrico
        UNION ALL
        SELECT 
            'SEGNALI' as settore, cod, descrizione, categoria, quantita::INTEGER, ubicazione, attivo
        FROM articoli_segnali
        UNION ALL
        SELECT 
            'STRUTTURE' as settore, cod, descrizione, categoria, quantita::INTEGER, ubicazione, attivo
        FROM articoli_strutture
        UNION ALL
        SELECT 
            'ALLESTIMENTO' as settore, cod, descrizione, categoria, quantita::INTEGER, ubicazione, attivo
        FROM articoli_allestimento
        UNION ALL
        SELECT 
            'ATTREZZATURE' as settore, cod, descrizione, categoria, quantita::INTEGER, ubicazione, attivo
        FROM articoli_attrezzature
        UNION ALL
        SELECT 
            'BACKLINE' as settore, cod, descrizione, categoria, quantita::INTEGER, ubicazione, attivo
        FROM articoli_backline
        UNION ALL
        SELECT 
            'RIGGHERAGGIO' as settore, cod, descrizione, categoria, quantita::INTEGER, ubicazione, attivo
        FROM articoli_riggheraggio
        UNION ALL
        SELECT 
            'GENERICO' as settore, cod, descrizione, categoria, quantita::INTEGER, ubicazione, attivo
