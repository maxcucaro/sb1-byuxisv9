...
CREATE INDEX IF NOT EXISTS idx_materiali_richiesti_lookup 
ON materiali_richiesti(settore, articolo_cod, stato);

CREATE INDEX IF NOT EXISTS idx_schede_lavoro_date_stato 
ON schede_lavoro(data_inizio, stato);

-- Grant execute permission
GRANT EXECUTE ON FUNCTION get_disponibilita_futura TO PUBLIC;

-- Add comment
COMMENT ON FUNCTION get_disponibilita_futura IS 'Calcola la disponibilità futura di un articolo ad una data specifica';